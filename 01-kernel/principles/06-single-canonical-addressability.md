...
- [Navigation as a Map, Not a Funnel](../patterns/navigation-as-map.md) — the craft of building the discovery overlay this principle permits: multiple entry vectors, described links, hub-as-map
